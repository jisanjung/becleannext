  ...
  <div className="relative h-15 w-15 sm:h-10 sm:w-10 lg:h-15 lg:w-15">
    <Image src={sideImages.right} alt="" fill className="object-contain" />
      ...
      <p className="mx-auto mb-10 max-w-md text-center text-white text-sm sm:text-base lg:max-w-3xl lg:text-xl px-6 sm:px-">
        At beclean ceramic coating studio of Gladwyne, our innovative ceramic coating service was created to highest level of ease, convince, and craftsmanship as possible. Look below to see the treatment that you receive when it arrives at our Harleysville shop.
      </p>
