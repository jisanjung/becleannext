    ...
    <section className="w-full bg-[#363434] py-16">
      <div className="max-w-7xl mx-auto px-4 md:px-10">
        ...
        <h2 className="mb-6 text-2xl font-bold text-white lg:text-5xl">
          What’s Included in Our Level 1 
          <br/>
          Ceramic Coating Service?
        </h2>

        <p className="text-white text-lg lg:text-xl max-w-full lg:max-w-none">
          At beclean Ceramic Coating Studio, our 1 year ceramic coating sets the baseline for what we consider acceptable protection and finish. Applied with precision, it provides all the defining advantages of ceramic coating while maintaining an intentional approach.
        </p>
