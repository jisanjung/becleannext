...
const Logistics = () => {
  return (
    <section className='wrapper px-4 md:px-10 py-4 mt-4'>
        <h3 className='mb-8'><span className='text-2xl font-bold text-gray-500'>The Art of Ceramic Coatings.</span>
            <br/>
        ...
        <div className='mb-8'>
            <h4 className='text-xl font-bold mb-4'>Book.</h4>
            <p className='mb-4'>
        ...
        <div className='mb-8'>
            <h4 className='text-xl font-bold mb-4'>Pickup.</h4>
            <p className='mb-4'>
        ...
        <div className='mb-8'>
            <h4 className='text-xl font-bold mb-4'>Delivered.</h4>
            <p className='mb-4'>
