...
const AboutSection = () => {
  return (
    <section className='wrapper px-4 md:px-10 py-4 mt-4'>
        <h3 className='mb-4'><span className='text-2xl font-bold text-gray-500 lg:text-4xl'>Choose beclean.</span>
            <br/>
            <span className='text-2xl font-bold lg:text-4xl'>
                8 - Year Ceramic Coating Service.
            </span>
        </h3>
        <div>
            <p className='mb-4 lg:text-lg lg:mb-6'>
        ...
        <h3 className='mb-4'><span className='text-2xl font-bold text-gray-500 lg:text-4xl'>Who Should Get This?</span>
            <br/>
            <span className='text-2xl font-bold lg:text-4xl'>
