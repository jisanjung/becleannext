...
<h2 className="mb-6 text-2xl font-bold text-white lg:text-5xl">
  What’s Included in Our Valley Forge
  <br/>
  Ceramic Coating Service?
</h2>

        <p className="text-white text-lg lg:text-xl max-w-full lg:max-w-none">
          At beclean ceramic coating studio of Valley Forge, our service goes beyond our ceramic coating services. What we include with every ceramic coating service is there to make sure that your ceramic coating lasts as long as possible. It’s not only about the service, but the journey your car goes on after.
        </p>
